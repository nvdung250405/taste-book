      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 gap-4 bg-slate-50 dark:bg-slate-900/30 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800">
          ...
          <p className="text-slate-500 text-sm max-w-sm text-center">
            Rất tiếc, không có món ăn nào khớp với bộ lọc của bạn. Vui lòng thử
            từ khóa hoặc tiêu chí khác.
          </p>
          <Button
            onClick={clearAllFilters}
                    ...
                    <div className="relative h-52 overflow-hidden shrink-0">
                      ...
                      {recipe.difficulty && (
                        <div className="absolute bottom-3 left-3">
                          <span
                            className={`text-xs font-semibold px-2.5 py-1 rounded-full shadow-sm ${DIFFICULTY_COLORS[recipe.difficulty] || 'bg-slate-100 text-slate-600'}`}
                          >
